                ...
                <div class="card-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="#preferences" class="nav-link" aria-controls="preferences" role="tab" data-toggle="tab">@lang('labels.frontend.user.profile.preferences')</a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade show pt-3" id="preferences" aria-labelledby="preferences-tab">
                                @include('frontend.user.account.tabs.preferences')
                            </div><!--tab panel profile-->

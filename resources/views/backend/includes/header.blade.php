<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="{{ route('admin.account.dashboard') }}">
    ...
    <button class="navbar-toggler aside-menu-toggler d-md-down-none invisible" type="button" data-toggle="aside-menu-lg-show">
        <span class="navbar-toggler-icon"></span>
    </button>
    <button class="navbar-toggler aside-menu-toggler d-lg-none invisible" type="button" data-toggle="aside-menu-show">
        <span class="navbar-toggler-icon"></span>
    </button>
</header>
